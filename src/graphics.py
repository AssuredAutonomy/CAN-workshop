...
class Gui():
    def __init__(self):
        ...
        self.blinker_L = self.factory.from_image("img/Blinker_L.png")
        self.blinker_R = self.factory.from_image("img/Blinker_R.png")
        ...
        def display_gui():
            ...
            self.spriterenderer.render(self.blinker_L)
            self.spriterenderer.render(self.blinker_R)
